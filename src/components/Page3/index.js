...
function Auth3Component({ setProgress }) {
  ...
  const handleSkillSelection = (skill) => {
    if (selectedSkills.some((s) => s.skill === skill)) return;

    setSelectedSkills([...selectedSkills, { skill, id: Date.now() }]);
  };

  const handleSkillRemoval = (e, skill) => {
    e.stopPropagation();
      ...
      <div classNam="main-3">
                  ...
                  >
                    ...
                    {selectedSkills.some((s) => s.skill === skill) && (
                      <span
                        ...
                        onClick={(e) => handleSkillRemoval(e, skill)}
                      >
                        &nbsp; &#10005;
                      </span>
                    )}
        ...
        <div className="explain hidethis">
          ...
          {/* {selectedSkills.map((s) => (
            <div key={s.id} className="selected-skill">
              {s.skill}
              <span
                className="remove-skill"
                onClick={(e) => handleSkillRemoval(e, s.skill)}
              >
                &#10005;
              </span>
            </div>
