            ...
            <div className="people-post">
              <div className="post-1">
                ...
                <div className="reactions">
                  ...
                  ></i> 
                  <div onClick={openPopup} className="like-count">{post.likes.length} likes</div>
                  {isPopupOpen && <Popup onClose={closePopup} setProgress={setProgress} postId={postId} likesCount={post.likes.length} />}
                ...
                <div className="displayComments">
                  ...
                  />
                  <button disabled={comment.length === 0} onClick={handleComments}>Post</button>
                </div>
                <div className="comments-container">
                  <h3 style={{marginBottom: "3px"}}>Comments ({commentList.length})</h3>
                  {fetchingComments && <img src={spinner} style={{ height: "55px", width: "55px" }} alt='loading' />}
                  {fetchingComments===false && commentList.length === 0 ? "No comments yet" : ""}
                  {commentList &&
